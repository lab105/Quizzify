...
const Welcome = () => {
  ...
  const handleStart = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/noassistance/`, {
        user: roll_no,
        action: "Start",
        page: 0,
        time: curtime,
    ...
    <div className="lg:flex lg:flex-row">
      <div className="lg:w-2/3">
        <div className="h-full flex flex-col justify-center items-center text-blue-texts font-thefont gap-y-3 p-8 lg:p-16">
          <div>
            <p className="text-center text-3xl lg:text-7xl">Welcome!</p>
            <p className="pt-10 px-6 lg:px-10 text-left text-xl lg:text-3xl">
              Welcome to our study! We appreciate your participation in this
              quiz, which will help us gather valuable insights. Before we
              begin, please take a moment to relax, focus your mind, and prepare
              to give your best effort. Remember, just do your best!
            </p>
            <br />
